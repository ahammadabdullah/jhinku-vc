const ru = {
  // Dashboard
  dashboard_title: "Панель jhinku-vc",
  dashboard_description:
    "Добро пожаловать в панель jhinku-vc — управляй и настраивай свой голосовой канал.",
  dashboard_create_link:
    "Твой голос — твоя комната. Начни здесь: https://discord.com/channels/{guildId}/{channelId}",
  ...
  // DND
  dnd_on:
    "Режим 'Не беспокоить' включён. Пользователи могут заходить, но не смогут говорить.",
  dnd_off:
    "Режим 'Не беспокоить' выключен. Все могут говорить и взаимодействовать.",
  ...
  error_user_dms_closed:
    "Невозможно отправить ЛС. Возможно, ЛС отключены или это бот.",
  ...
  interaction_already_active:
    "Уже есть активная сессия. Заверши её перед новой.",
  invalid_category:
    "CATEGORY_CHANNEL_ID недействителен или не является категорией.",
  invalid_embed:
    "EMBED_CHANNEL_ID недействителен или не является текстовым каналом.",
  invalid_voice:
    "VOICE_CHANNEL_ID недействителен или не является голосовым каналом.",
};
