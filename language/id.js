const id = {
  // Dashboard
  dashboard_title: "Dasbor Jhinku-vc",
  dashboard_description:
    "Selamat datang di dasbor Jhinku-vc kamu — atur dan sesuaikan ruang obrolan suaramu.",
  dashboard_create_link:
    "Suaramu, ruangmu. Mulai ruang di https://discord.com/channels/{guildId}/{channelId}",
  ...
  // DND
  dnd_on:
    "Mode Jangan Ganggu aktif. Orang lain bisa masuk tapi nggak bisa bicara atau interaksi.",
  dnd_off:
    "Mode Jangan Ganggu nonaktif. Orang lain bisa ngobrol di channel kamu.",
  ...
  invite_message:
    "Kamu diundang untuk gabung ke channel suara: {name}\n{voiceLink}",
  invited_user: "{user} telah diundang.",
  error_send_invite: "Gagal mengirim undangan ke user.",
  error_user_dms_closed:
    "DM user tidak bisa dihubungi. Mungkin dinonaktifkan atau dia bot.",
  ...
  privacy_closechat:
    "Chat ditutup. Hanya kamu dan user terpercaya yang bisa chat.",
