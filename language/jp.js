const jp = {
  // Dashboard
  dashboard_title: "jhinku-vc ダッシュボード",
  dashboard_description:
    "ようこそ、jhinku-vc ダッシュボードへ — あなたのボイスチャンネルを管理・カスタマイズしよう。",
  dashboard_create_link:
    "自分の声、自分の空間。今すぐ始めよう: https://discord.com/channels/{guildId}/{channelId}",
  ...
  // DND
  dnd_on:
    "取り込み中モードがオンになりました。他の人は入れますが、話したり操作できません。",
  dnd_off:
    "取り込み中モードがオフになりました。他の人も話せるようになりました。",
  ...
  privacy_lock:
    "チャンネルをロックしました。信頼済みユーザーのみが参加できます。",
  ...
  interaction_already_active:
    "すでにアクティブな操作があります。先にそれを完了してください。",
  invalid_category: "CATEGORY_CHANNEL_ID は無効か、カテゴリではありません。",
  invalid_embed:
    "EMBED_CHANNEL_ID は無効か、テキストチャンネルではありません。",
